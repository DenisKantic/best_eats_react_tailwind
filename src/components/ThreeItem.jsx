const ThreeItem = () => {
    return ( 
       ...
       <div className="rounded-xl w-[500px] hhttps://images.pexels.com/photos/1049626/pexels-photo-1049626.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1-full relative overflow-hidden xss:w-full mb-4 mr-4">
       <div className="w-full h-full bg-black/40 absolute  flex flex-col justify-center">
