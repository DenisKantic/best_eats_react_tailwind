const ThreeItem = () => {
    return ( 
       ...
       <div className="flex justify-between items-center xss:flex-col md:flex-col lg:flex">
    
       <div className="rounded-xl w-[500px] h-full relative overflow-hidden xss:w-full mb-4">
       <div className="w-full h-full bg-black/40 absolute  flex flex-col justify-center">
       <h1 className="absolute top-2 p-2 text-2xl text-white font-bold xss:text-xl">Sun's Out, BOGO's Out</h1>
        <h3 className="absolute top-8 p-2 text-lg text-white xss:text-lg">Through 8/26</h3>
