...
const Navigation = () => {
  ...
  return (
    ...
    <h1 className='xss:text-2xl sm:text-3xl lg:text-xl absolute top-4 left-4'>Best <span className='font-bold'>Eats</span></h1>
    ...
    <ul className='flex flex-col p-4 mt-[50px]'>
      <li className='flex py-4 items-center hover:text-red-700 cursor-pointer'><TbTruckDelivery className='mr-4' size={25}></TbTruckDelivery><span className='xxs:text-xl mediumEnd:text-lg lg:text-lg'>Orders</span> </li>
      <li className='flex py-4 items-center hover:text-red-700 cursor-pointer'><AiFillHeart className='mr-4' size={25}></AiFillHeart><span className='xxs:text-xl mediumEnd:text-lg lg:text-lg'>Favorites</span></li>
      <li className='flex py-4 items-center hover:text-red-700 cursor-pointer'><FaWallet className='mr-4' size={25}></FaWallet><span className='xxs:text-xl mediumEnd:text-lg lg:text-lg'>Wallet</span></li>
      <li className='flex py-4 items-center hover:text-red-700 cursor-pointer'><AiFillQuestionCircle className='mr-4' size={25}></AiFillQuestionCircle><span className='xxs:text-xl mediumEnd:text-lg lg:text-lg'>Help</span></li>
      <li className='flex py-4 items-center hover:text-red-700 cursor-pointer'><ImPriceTag className='mr-4' size={25}></ImPriceTag><span className='xxs:text-xl mediumEnd:text-lg lg:text-lg'>Promotions</span></li>
      <li className='flex py-4 items-center hover:text-red-700 cursor-pointer'><FaUserFriends className='mr-4' size={25}></FaUserFriends><span className='xxs:text-xl mediumEnd:text-lg lg:text-lg'>Invite Friends</span></li>
    </ul>
    </div>
    </div>
  )
